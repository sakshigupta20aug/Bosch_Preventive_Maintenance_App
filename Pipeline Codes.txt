...
REM -------------------------
CALL C:\Users\saksh\anaconda3\Scripts\activate.bat base
IF %ERRORLEVEL% NEQ 0 (
...
jupyter nbconvert --to notebook --execute --inplace "C:\Users\saksh\Downloads\Internship\Bosch_Project\scripts\EDA.ipynb"
IF %ERRORLEVEL% NEQ 0 (
...
jupyter nbconvert --to notebook --execute --inplace "C:\Users\saksh\Downloads\Internship\Bosch_Project\scripts\Feature_Engineering.ipynb"
IF %ERRORLEVEL% NEQ 0 (
...
jupyter nbconvert --to notebook --execute --inplace "C:\Users\saksh\Downloads\Internship\Bosch_Project\scripts\classification_model.ipynb"
IF %ERRORLEVEL% NEQ 0 (
...
jupyter nbconvert --to notebook --execute --inplace "C:\Users\saksh\Downloads\Internship\Bosch_Project\scripts\load_to_sqlserver.ipynb"
IF %ERRORLEVEL% NEQ 0 (
...
cd "C:\Users\saksh\Downloads\Internship\Bosch_Project"
git pull
git add .
